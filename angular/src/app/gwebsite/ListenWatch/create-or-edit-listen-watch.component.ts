...
@Component({
    selector: 'createOrEditLWLessonModal',
    templateUrl: './create-or-edit-listen-watch.component.html'
})
export class CreateOrEditLWLessonModalComponent extends AppComponentBase {
