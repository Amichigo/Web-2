...
@Component({
    selector: 'createOrEditRWLessonModal',
    templateUrl: './create-or-edit-read-write-lesson.component.html'
})
export class CreateOrEditRWLessonModalComponent extends AppComponentBase {
