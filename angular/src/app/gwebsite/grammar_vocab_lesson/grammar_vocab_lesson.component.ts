...
@Component({
    selector: 'grammar-vocab-lesson',
    templateUrl: './grammar_vocab_lesson.component.html',
    animations: [appModuleAnimation()],
    styles: ['.disapear{display:none}']
})
export class GrammarVocabLessonComponent extends AppComponentBase implements AfterViewInit, OnInit {
