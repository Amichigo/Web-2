...
export class ArticleServiceProxy {
     ...
     * @return Success
     */
    getArticlesByFilter(topic: string | null | undefined, catName: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfArticleDto> {
        let url_ = this.baseUrl + "/api/Article/GetArticlesByFilter?";
        if (topic !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetArticlesByFilter(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetArticlesByFilter(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfArticleDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfArticleDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetArticlesByFilter(response: HttpResponseBase): Observable<PagedResultDtoOfArticleDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfArticleDto.fromJS(resultData200) : new PagedResultDtoOfArticleDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfArticleDto>(<any>null);
    }
     ...
     * @return Success
     */
    getArticleForEdit(id: number | null | undefined): Observable<ArticleInput> {
        let url_ = this.baseUrl + "/api/Article/GetArticleForEdit?";
        if (id !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetArticleForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetArticleForEdit(<any>response_);
                } catch (e) {
                    return <Observable<ArticleInput>><any>_observableThrow(e);
                }
            } else
                return <Observable<ArticleInput>><any>_observableThrow(response_);
        }));
    }

    protected processGetArticleForEdit(response: HttpResponseBase): Observable<ArticleInput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ArticleInput.fromJS(resultData200) : new ArticleInput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ArticleInput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEditArticle(input: ArticleInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Article/CreateOrEditArticle";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrEditArticle(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditArticle(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateOrEditArticle(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getArticleForView(id: number | null | undefined): Observable<ArticleForView> {
        let url_ = this.baseUrl + "/api/Article/GetArticleForView?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetArticleForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetArticleForView(<any>response_);
                } catch (e) {
                    return <Observable<ArticleForView>><any>_observableThrow(e);
                }
            } else
                return <Observable<ArticleForView>><any>_observableThrow(response_);
        }));
    }

    protected processGetArticleForView(response: HttpResponseBase): Observable<ArticleForView> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ArticleForView.fromJS(resultData200) : new ArticleForView();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ArticleForView>(<any>null);
    }
}
...
export class CategoryServiceProxy {
     ...
     * @return Success
     */
    getCategoriesByFilter(id: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfCategoryDto> {
...
export class CommentServiceProxy {
     ...
     * @return Success
     */
    getCommentsByFilter(userId: number | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfCommentDto> {
        let url_ = this.baseUrl + "/api/Comment/GetCommentsByFilter?";
        if (userId !== undefined)
            url_ += "UserId=" + encodeURIComponent("" + userId) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCommentsByFilter(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCommentsByFilter(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfCommentDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfCommentDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetCommentsByFilter(response: HttpResponseBase): Observable<PagedResultDtoOfCommentDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<PagedResultDtoOfCommentDto>(<any>null);
    }
     ...
     * @return Success
     */
    getCommentForEdit(id: number | null | undefined): Observable<CommentInput> {
        let url_ = this.baseUrl + "/api/Comment/GetCommentForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CommentInput>><any>_observableThrow(e);
                }
            } else
                return <Observable<CommentInput>><any>_observableThrow(response_);
        }));
    }

    protected processGetCommentForEdit(response: HttpResponseBase): Observable<CommentInput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CommentInput.fromJS(resultData200) : new CommentInput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CommentInput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEditComment(input: CommentInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Comment/CreateOrEditComment";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrEditComment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditComment(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateOrEditComment(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    deleteComment(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/Comment/DeleteComment/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class LessonServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getLessonsByFilter(catName: string | null | undefined, lessonContent: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfLessonDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetLessonsByFilter(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetLessonsByFilter(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfLessonDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfLessonDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetLessonsByFilter(response: HttpResponseBase): Observable<PagedResultDtoOfLessonDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfLessonDto.fromJS(resultData200) : new PagedResultDtoOfLessonDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfLessonDto>(<any>null);
    }
     ...
     * @return Success
     */
    getLessonForEdit(id: number | null | undefined): Observable<LessonInput> {
        let url_ = this.baseUrl + "/api/Lesson/GetLessonForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetLessonForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetLessonForEdit(<any>response_);
                } catch (e) {
                    return <Observable<LessonInput>><any>_observableThrow(e);
                }
            } else
                return <Observable<LessonInput>><any>_observableThrow(response_);
        }));
    }

    protected processGetLessonForEdit(response: HttpResponseBase): Observable<LessonInput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? LessonInput.fromJS(resultData200) : new LessonInput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<LessonInput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEditLesson(input: LessonInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Lesson/CreateOrEditLesson";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrEditLesson(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditLesson(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateOrEditLesson(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    deleteLesson(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/Lesson/DeleteLesson/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteLesson(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
     ...
     * @return Success
     */
    getLessonForView(id: number | null | undefined): Observable<LessonForViewDto> {
        let url_ = this.baseUrl + "/api/Lesson/GetLessonForView?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetLessonForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetLessonForView(<any>response_);
                } catch (e) {
                    return <Observable<LessonForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<LessonForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetLessonForView(response: HttpResponseBase): Observable<LessonForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? LessonForViewDto.fromJS(resultData200) : new LessonForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<LessonForViewDto>(<any>null);
    }
}
...
export class PagedResultDtoOfArticleDto implements IPagedResultDtoOfArticleDto {
    totalCount!: number | undefined;
    items!: ArticleDto[] | undefined;

    constructor(data?: IPagedResultDtoOfArticleDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PagedResultDtoOfArticleDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfArticleDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfArticleDto {
    totalCount: number | undefined;
    items: ArticleDto[] | undefined;
}
...
export class ArticleInput implements IArticleInput {
    ...
    static fromJS(data: any): ArticleInput {
        data = typeof data === 'object' ? data : {};
        let result = new ArticleInput();
        result.init(data);
        return result;
    }
...
export class ArticleForView implements IArticleForView {
    catName!: string | undefined;
    topic!: string | undefined;
    content!: string | undefined;
    userId!: number | undefined;

    constructor(data?: IArticleForView) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ArticleForView {
        data = typeof data === 'object' ? data : {};
        let result = new ArticleForView();
        result.init(data);
        return result;
    }
...
export interface IArticleForView {
    catName: string | undefined;
    topic: string | undefined;
    content: string | undefined;
    userId: number | undefined;
...
export class CategoryDto implements ICategoryDto {
    ...
    init(data?: any) {
        if (data) {
            this.catName = data["catName"];
            this.catImage = data["catImage"];
            this.catContent = data["catContent"];
            this.id = data["id"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["catContent"] = this.catContent;
        data["id"] = this.id;
        return data; 
    }
}
...
export class PagedResultDtoOfLessonDto implements IPagedResultDtoOfLessonDto {
    totalCount!: number | undefined;
    items!: LessonDto[] | undefined;

    constructor(data?: IPagedResultDtoOfLessonDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PagedResultDtoOfLessonDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfLessonDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfLessonDto {
    totalCount: number | undefined;
    items: LessonDto[] | undefined;
}
...
export class LessonDto implements ILessonDto {
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["introImage"] = this.introImage;
...
export class LessonInput implements ILessonInput {
    introImage!: string | undefined;
    lessonContent!: string | undefined;
    link!: string | undefined;
    catName!: string | undefined;
    ...
    static fromJS(data: any): LessonInput {
        data = typeof data === 'object' ? data : {};
        let result = new LessonInput();
        result.init(data);
        return result;
    }
...
export class LessonForViewDto implements ILessonForViewDto {
    introImage!: string | undefined;
    lessonContent!: string | undefined;
    link!: string | undefined;
    catName!: string | undefined;

    constructor(data?: ILessonForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LessonForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new LessonForViewDto();
        result.init(data);
        return result;
    }
...
export interface ILessonForViewDto {
    introImage: string | undefined;
    lessonContent: string | undefined;
    link: string | undefined;
    catName: string | undefined;
